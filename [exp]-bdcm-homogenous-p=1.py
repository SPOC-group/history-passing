...
experiments += [('0' * 50 +  '1' * 50, 80000, 40, 2400, 0.001)]
experiments += [('0' * 100 +  '1' * 100, 80000, 40, 2400, 0.001)]
experiments = []
experiments += [('0' * 75 +  '1' * 75, 80000, 40, 2400, 0.001)]

experiments += [('0' * 125 +  '1' * 125, 80000, 40, 2400, 0.001)]
